    ...
    <div className="h-full relative">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-400">Real-time agent workspace</p>
        </div>
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 text-sm">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-gray-400">{awayCount} Away</span>
            </div>
          </div>
        </div>
      </div>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  <div className={`w-14 h-14 rounded-full bg-gradient-to-br ${agent.color} flex items-center justify-center text-3xl`}>
                    {agent.avatar}
                  </div>
                  <div>
                    <div className="flex items-center gap-2">
